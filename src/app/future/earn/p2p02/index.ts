...
@Component({
  ...
  imports: [SidebarComponent, HeaderComponent, Bonds02TableComponent, MatIconModule, BannerComponent, RouterLink, RouterLinkActive, MatButtonModule],
  standalone: true
})
export class P2p02Component {
